...
var points = [
    ...
    },
    {
      ...
      "properties": {
        ...
        "year": "1965",
        "employ": "4,500",
        "txt": "PNNL is a scientific research and development laboratory with world-leading capabilities in chemistry, earth sciences, and data analytics that are addressing key challenges in energy resiliency, and national and homeland security.",
    ...
    },
    {
      ...
      "properties": {
        ...
        "year": "1962",
        "employ": "2,000",
        "txt": "SLAC National Accelerator Laboratory develops and operates some of the world’s premier science facilities, including the first hard X-ray free-electron laser. Research at SLAC explores the structure and function of matter and the properties of energy, space and time, at the smallest and largest scales, all with the goal of solving problems facing society and advancing human knowledge.",
...
var index = 0;
var facility = document.getElementById('r-n-header-labs');
var year = document.getElementById('r-n-sc-i1-year');
var employees = document.getElementById('r-n-sc-i1-employees');
var research = document.getElementById('r-n-sc-info2');
var link = document.getElementById('r-n-sc-site');
var slide = document.getElementById('see-more');
var labs_info = document.getElementById('r-n-sc-lab');
...
slide.onclick=function(){
  if (slide.className == "active") {
    ...
    labs_info.className="slide-tab inactive"
    slide.innerHTML = "<span href='#'>Show</span>";

  } else{
    slide.className="active"
    labs_info.className="slide-tab active"
    slide.innerHTML = "<span href='#'>Hide</span>";
  };
};



var map = L.mapbox.map('map', 'energy.hlo44ea4',{
      maxZoom: 9,
      minZoom: 3,
      zoomControl: false
    });

map.setView([37.908, -94.525], 4);
...
usa.onclick=function(){
 map.fitBounds([
  ...
  // else if (map.getZoom() == 4) {map.panTo([location.lat + 8,location.lng]);}
...
//       //set to shallower zoom on small view size (mobile)
//       match : function() {
//         // map.setView([37.6773, -92.708], 3);
//         console.log('match')
//       },      
//       //set back to deeper zoon on larger view size                          
//       unmatch : function() {
//         // map.setView([37.6773, -92.708], 4);
//         console.log('unmatch')
//       } 
//     });
...
// map.featureLayer.setGeoJSON(points)

// L.marker.on('click', onClick);
...
if (layer1 !== 1) {layer1.setIcon(L.mapbox.marker.icon({
          'marker-symbol': 'star', 
          'marker-color': '91e5b6',
          'marker-size': 'medium'
        }));}
...
e.target.setIcon(L.mapbox.marker.icon({
  ...
  layer1 = this;
      ...
      var point_Clicked = e.target.options.values;
    ...
    if (index !== 1) {
    //change DOM in sidebar
    facility.className = "";
    }

      if (point_Clicked.facility.length <= 22) {
        facility.className = ("one-line")
      } else if (point_Clicked.facility.length <= 45){
        facility.className = ("two-line")
      } else {
        facility.className = ("three-line")
      };


    facility.innerHTML = "<h2><a target='_target' href='"+ point_Clicked.website + "'>" + point_Clicked.facility + "</a></h2>";
    year.innerHTML = "<h4>Founded</h4><p>"+ point_Clicked.year +"</p>";
    employees.innerHTML = "<h4>Employees</h4><p>"+ point_Clicked.employ +"</p>"
    research.innerHTML = "<h4>Location</h4><p>" + point_Clicked.city + ", " + point_Clicked.state + "</p><h4>Research</h4><p>"+ point_Clicked.txt +"</p>"
    link.innerHTML = "<a target='_target' href='" + point_Clicked.website + "'>Visit this lab's site</a>";
}
